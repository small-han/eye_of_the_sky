...
int main(int, char**){
	...
	VideoCapture videoOne("2011_09_29_2/image_00/data/0000000000.png"); //Absolute path to the KITTI left grey frames
	VideoCapture videoTwo("2011_09_29_2/image_01/data/0000000000.png"); //Absolute path to the KITTI right grey frames
    ...
    list_dir("2011_09_29_2/image_00/data/", files);
    sort(files.begin(),files.end());

for(auto s:files){
    cout<<s<<endl;
    m_imageLeft =  imread("2011_09_29_2/image_00/data/"+s);
    m_imageRight = imread("2011_09_29_2/image_01/data/"+s);
    // videoOne.read(left);
    // videoTwo.read(right);
    ...
    if(!no_display)
    {
        ...
        imshow("left", m_imageLeft);
        moveWindow("left", 200,500);
        namedWindow("right", WINDOW_AUTOSIZE);
        imshow("right", m_imageRight);
        moveWindow("right", 1400,500);
        ...
        namedWindow("DisparityBONE", WINDOW_AUTOSIZE);
        imshow("DisparityBONE", imgCalorBONE);
        moveWindow("DisparityBONE", 200,0);
        namedWindow("DisparityHOT", WINDOW_AUTOSIZE);
        imshow("DisparityHOT", imgCalorHOT);
        moveWindow("DisparityHOT", 1400,0);

		// imshow("Left image", imgCalorBONE);
		// imshow("Right image", imgCalorHOT);
