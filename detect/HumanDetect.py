...
class Detection:
    ...
    def __init__(self,network="ssd-mobilenet-v2",width=1080,height=720,overlay="none"):
    ...
    def Get_Target(self,detections):
        res=[]
        for dec in detections:
            if self.net.GetClassDesc(dec.ClassID)=="person":
                res.append(dec.Center)
        return res
